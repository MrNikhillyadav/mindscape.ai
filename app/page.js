...
export default function Home() {
  return (
      ...
      <div className="  w-full  flex flex-col justify-center  items-center">
            ...
            <div className=' flex flex-col justify-center items-center p-4   mt-[18vh]'>
            ...
            <Link href='/chatPage' >
              ...
              <Image src={"/heroImg.png"} width={1000} height={800} alt="heroImg"
              className="border  rounded-md shadow-lg text-center bg-"/>
